...
const MAP_DEFS = [
  // ===== マップ 0: 草原 =====
  {
    ...
    enemies: [
      ...
      { name: "野うさぎ",  img: "img/enemy/enemy_slime.png",
        drops: [{ itemId: "rabbit_fur", rate: 0.45 }],
    ...
    rare: { name: "黄金スライム", img: "img/enemy/enemy_slime.png",
      rate: 0.04, hpMult: 0.3, atkMult: 0.05, goldMult: 10,
  ...
  // ===== マップ 2: 洞窟 =====
  {
    ...
    boss: { name: "岩窟の番人", img: "img/enemy/enemy_orc.png", critRes: 0.25,
      drops: [{ itemId: "orc_hide", rate: 0.9 }, { itemId: "bat_wing", rate: 0.9 }],
  ...
  // ===== マップ 5: 火山 =====
  {
    ...
    enemies: [
      { name: "ラバスライム",   img: "img/enemy/enemy_troll.png",
        critRes: 0.20,
        drops: [{ itemId: "fire_gem", rate: 0.50 }],
      ...
      { name: "マグマゴーレム", img: "img/enemy/enemy_dragon.png",
        critRes: 0.35,
        drops: [{ itemId: "orc_hide", rate: 0.40 }, { itemId: "fire_gem", rate: 0.20 }],
    ...
    rare: { name: "不死鳥", img: "img/enemy/enemy_dragon.png",
      ...
      drops: [{ itemId: "fire_gem", rate: 0.95 }, { itemId: "troll_blood", rate: 0.40 }],
    ...
    boss: { name: "火竜", img: "img/enemy/enemy_dragon.png",
      ...
      drops: [{ itemId: "troll_blood", rate: 0.9 }, { itemId: "fire_gem", rate: 0.9 }],
  ...
  // ===== マップ 7: 天空 =====
  {
    ...
    rare: { name: "天空の守護者", img: "img/enemy/enemy_dragon.png",
      ...
      drops: [{ itemId: "sky_crystal", rate: 0.95 }, { itemId: "dragon_scale", rate: 0.50 }],
      killBonus: [{ str:4, agi:3 }, { str:8, agi:6, luk:3 }, { str:14, agi:11, luk:6 }] },
    boss: { name: "天空の番人", img: "img/enemy/enemy_dragon.png",
      evasion: 0.15,
      drops: [{ itemId: "sky_crystal", rate: 0.9 }, { itemId: "dragon_scale", rate: 0.9 }],
